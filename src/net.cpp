...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Metticoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
  {"metticoin.sells-it.net","dnsseed.metticoin.sells-it.net"},
  {NULL, NULL}
};
...
unsigned int pnSeed[] =
{
0x9b058557, 0x9b058557 , 0x9b58557
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Metticoin is probably already running."), addrBind.ToString().c_str());
        else
